...
class Expando {
  constructor() {
    ...
    this._elInnerInverter = this._el.querySelector(
      ".js-expando-inner-inverter"
    );
  ...
  _calculate() {
    ...
    this._elInner.style.transformOrigin = `${collapsedWidth * 0.5}px ${
      collapsedHeight * 0.5
    }px`;
    this._elInnerInverter.style.transformOrigin = `${collapsedWidth * 0.5}px ${
      collapsedHeight * 0.5
    }px`;
  }
